...
var wordArray1 = ['autumn','cranberry','hayride','harvest','pumpkin','football']
...
HangMan.prototype.getWordArray = function(){
  ...
  var levelNumber = parseInt(gameLevel.innerHTML);
  ...
  if(levelNumber === 3){return this.wordArray = ['foraging','foliage','rustling','scarecrow','werewolf','thanksgiving'];}
};
...
$('.new-word-button').on('click', function(){
 ...
 function levelUp() {
   ...
   var levelNumber = parseInt(gameLevel.innerHTML);
     levelNumber++;
     gameLevel.innerHTML = levelNumber;
